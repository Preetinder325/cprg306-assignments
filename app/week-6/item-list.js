  ...
  return (
    <div className="container mx-auto mt-5">
      ...
      {/* Used pinch of GPT for knowing the transition. */}
        ...
        <button
          className={`px-4 py-2 text-sm font-medium rounded-md transition duration-500 ease-in-out ${sortBy === 'category' ? 'bg-blue-500 text-white' : 'bg-blue-200 text-blue-900'} hover:bg-blue-400`}
